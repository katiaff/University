 ...
 */
enum ScalePosition { LEFT, EQUAL, RIGHT };

/**
 * Class that takes the group of coins 
 * Gives a method to weigh and other auxiliary methods
 */
public class Coins {
	...
	/**
	 * Creates an instance with a group of coins that has 
	 * numberOfCoins with random weights and a fake coin 
	...
	/**
	 * Creates an instance with a group of coins 
	 * that is given
	...
	/**
	 * Function that weighs both sides of all currencies specified 
	 * in the parameters and returns to where the balance inclines
	 ...
	 * @return - ScalePosition.EQUAL The currencies of the two plates have the same weight
	 * 			 ScalePosition.LEFT The coins of the left have more weight
	 * 			 ScalePosition.RIGHT The coins of the right have more weight
	 */
	ScalePosition weigh(int leftSideStarts, int leftSideEnds, 
			int rightSideStarts, int rightSideEnds) {
		...
		else return ScalePosition.RIGHT;		
	}
	
	/**
	 * Auxiliary support method for printing the values of the
	 * currencies of a range
	 * @param starts Index of the initial element to be printed
	 * @param ends Index of the last element to be printed
	 */
	void prints(int starts, int ends) {
