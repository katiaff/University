...
public class BinaryHeapTest {
	...
	public void testAddAndRemove() {
		...
		// assertEquals("[[17(8)12](4)[9(6)20]](1)[[18(11)15](2)[14(3)]]",
		// heap.toString());
		assertEquals("1 4 2 8 6 11 3 17 12 9 20 18 15 14", heap.internalString());
		assertFalse(heap.remove(100));
		assertTrue(heap.remove(11));
		// assertEquals("[[17(8)12](4)[9(6)20]](1)[[18(14)15](2)3]",
		// heap.toString());
		assertEquals("1 4 2 8 6 14 3 17 12 9 20 18 15", heap.internalString());
		assertTrue(heap.remove(8));
		// assertEquals("[[17(12)15](4)[9(6)20]](1)[[18(14)](2)3]",
		// heap.toString());
		assertEquals("1 4 2 12 6 14 3 17 15 9 20 18", heap.internalString());
		assertTrue(heap.remove(1));
		// assertEquals("[[17(12)15](4)[9(6)20]](2)[14(3)18]", heap.toString());
		assertEquals("2 4 3 12 6 14 18 17 15 9 20", heap.internalString());
		assertTrue(heap.remove(17));
		// assertEquals("[[20(12)15](4)[9(6)]](2)[14(3)18]", heap.toString());
		assertEquals("2 4 3 12 6 14 18 20 15 9", heap.internalString());
		assertTrue(heap.remove(20));
		// assertEquals("[[12(9)15](4)6](2)[14(3)18]", heap.toString());
		assertEquals("2 4 3 9 6 14 18 12 15", heap.internalString());
		assertTrue(heap.remove(15));
		// assertEquals("[[12(9)](4)6](2)[14(3)18]", heap.toString());
		assertEquals("2 4 3 9 6 14 18 12", heap.internalString());
		assertTrue(heap.remove(4));
		// assertEquals("[9(6)12](2)[14(3)18]", heap.toString());
		assertEquals("2 6 3 9 12 14 18", heap.internalString());
		assertTrue(heap.remove(3));
		// assertEquals("[9(6)12](2)[18(14)]", heap.toString());
		assertEquals("2 6 14 9 12 18", heap.internalString());
		assertTrue(heap.remove(9));
		// assertEquals("[18(6)12](2)14", heap.toString());
		assertEquals("2 6 14 18 12", heap.internalString());
		assertTrue(heap.remove(18));
		// assertEquals("[12(6)](2)14", heap.toString());
		assertEquals("2 6 14 12", heap.internalString());
		assertTrue(heap.remove(6));
		// assertEquals("12(2)14", heap.toString());
		assertEquals("2 12 14", heap.internalString());
		assertTrue(heap.remove(12));
		// assertEquals("14(2)", heap.toString());
		assertEquals("2 14", heap.internalString());
		assertTrue(heap.remove(2));
		// assertEquals("14", heap.toString());
		assertEquals("14", heap.internalString());
