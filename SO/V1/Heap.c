...
// Insertion of a PID into a binary heap. Be carefull because DON'T modify number of elements in the queue
// info: PID to insert
...
// return 0/-1  ok/fail. Be carefull because DON'T modify number of elements in the queue
...
// Extract the more priority item.  Be carefull because DON'T modify number of elements in the queue
// heap: Binary heap to extract: user o daemon ready queue, sleeping queue, ...
// queueType: QUEUE_PRIORITY, QUEUE_WAKEUP, QUEUE_ARRIVAL, ...
// numElem: number of elements actually into the queue
// return more priority item into the queue. Be carefull because DON'T modify number of elements in the queue
